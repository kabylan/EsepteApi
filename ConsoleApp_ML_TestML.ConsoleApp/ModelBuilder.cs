...
using EsepteApi.Model;
using Microsoft.ML.Vision;

namespace EsepteApi.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\esept\AppData\Local\Temp\0ccbc7e7-5afd-40fa-b3ad-002bdc2a6adc.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\esept\AppData\Local\Temp\MLVSTools\ConsoleApp_ML_TestML\ConsoleApp_ML_TestML.Model\MLModel.zip";
